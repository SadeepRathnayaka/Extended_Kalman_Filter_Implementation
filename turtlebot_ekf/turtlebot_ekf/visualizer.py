...
class PredictedPathSub(Node):
    def __init__(self):
        ...
        self.predicted_odom_pub = self.create_publisher(Odometry, "/ekf/predicted_odom", 10)

        self.predicted_odom = Odometry()
        self.predicted_odom.header.frame_id = "odom"
        self.predicted_odom.child_frame_id = "predicted_odom"
    ...
    def callback(self, msg):
        ...
        self.predicted_odom.header.stamp = self.get_clock().now().to_msg()
        self.predicted_odom.pose.pose.position.x = x_t_[0]
        self.predicted_odom.pose.pose.position.y = x_t_[1]
        self.predicted_odom.pose.pose.orientation.x = pred_q[0]
        self.predicted_odom.pose.pose.orientation.y = pred_q[1]
        self.predicted_odom.pose.pose.orientation.z = pred_q[2]
        self.predicted_odom.pose.pose.orientation.w = pred_q[3]
        self.predicted_odom_pub.publish(self.predicted_odom)
...
class CorrectedPathSub(Node):
    def __init__(self):
        ...
        self.corrected_odom_pub = self.create_publisher(Odometry, "/ekf/corrected_odom", 10)

        self.corrected_odom = Odometry()
        self.corrected_odom.header.frame_id = "odom"
        self.corrected_odom.child_frame_id = "corrected_odom"
    ...
    def callback(self, msg) :
        ...
        self.corrected_odom.header.stamp = self.get_clock().now().to_msg()
        self.corrected_odom.pose.pose.position.x = x_t[0]
        self.corrected_odom.pose.pose.position.y = x_t[1]
        self.corrected_odom.pose.pose.orientation.x = corr_q[0]
        self.corrected_odom.pose.pose.orientation.y = corr_q[1]
        self.corrected_odom.pose.pose.orientation.z = corr_q[2]
        self.corrected_odom.pose.pose.orientation.w = corr_q[3]
        self.corrected_odom_pub.publish(self.corrected_odom)
...
class FusedPathSub(Node):
    def __init__(self):
        ...
        self.fused_odom_pub = self.create_publisher(Odometry, "/ekf/fused_odom", 10)

        self.fused_odom = Odometry()
        self.fused_odom.header.frame_id = "odom"
        self.fused_odom.child_frame_id = "fused_odom"
    ...
    def callback(self, msg) :
        ...
        self.fused_odom.header.stamp = self.get_clock().now().to_msg()
        self.fused_odom.pose.pose.position.x = x_t[0]
        self.fused_odom.pose.pose.position.y = x_t[1]
        self.fused_odom.pose.pose.orientation.x = corr_q[0]
        self.fused_odom.pose.pose.orientation.y = corr_q[1]
        self.fused_odom.pose.pose.orientation.z = corr_q[2]
        self.fused_odom.pose.pose.orientation.w = corr_q[3]
        self.fused_odom_pub.publish(self.fused_odom)
